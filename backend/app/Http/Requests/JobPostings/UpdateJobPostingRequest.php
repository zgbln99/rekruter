...
class UpdateJobPostingRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'points_per_day' => ['nullable', 'string', 'max:60'],
            'loading_info' => ['nullable', 'string', 'max:191'],
            'daily_km' => ['nullable', 'string', 'max:60'],
            'pdf_url' => ['nullable', 'string', 'max:255'],
            'faq' => ['nullable', 'array'],
            'faq.*.q' => ['nullable', 'string', 'max:191'],
            'faq.*.a' => ['nullable', 'string', 'max:500'],
