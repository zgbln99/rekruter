...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .accentbar { position: absolute; top: 0; left: 0; right: 0; height: 14px; background: #dc2626; }
        .truck { position: absolute; right: -50px; bottom: 180px; width: 720px; opacity: .05; }

        .wrap { position: relative; width: 100%; height: 100%; display: flex; flex-direction: column; padding: 76px 64px 64px; }
        ...
        .title { font-size: 94px; font-weight: 900; line-height: .96; letter-spacing: -2px; color: #0f172a; margin-top: 6px; }
        ...
        .cta { margin-top: 32px; display: flex; align-items: center; justify-content: space-between; border-top: 2px solid #f1f5f9; padding-top: 26px; }
